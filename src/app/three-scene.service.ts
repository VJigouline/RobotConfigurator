...
export class ThreeSceneService {
  ...
  contentSetter(scene: THREE.Scene, sceneGLTF: THREE.Scene | THREE.Group, clips: THREE.AnimationClip[]) {
  ...
  public rescaleScene(camera: THREE.OrthographicCamera = null,
                      box: THREE.Box3 = null, orbitControls: TrackballControls = null): void {
