...
export class SceneViewComponent implements OnInit, AfterViewInit {
  ...
  public onResized(event: ResizedEvent): void {
    ...
    this.sceneService.renderer.setSize(this.AreaWidth, this.AreaHeight - 6);
  ...
  private InitialiseScene(): void {
    ...
    this.sceneService.orbitControls = new TrackballControls( this.sceneService.camera, renderer.domElement );
  ...
  private onMouseMove(event: MouseEvent) {
    this.sceneService.orbitControls.update();
  }
  ...
  private InitialiseCamera(): void {
    ...
    this.sceneService.camera.position.z = 10000;
